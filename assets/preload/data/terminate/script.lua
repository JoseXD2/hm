...
function onCreate()
	...
	if difficulty == 2 then
		if downscroll == false then
			makeLuaSprite('ArrowError','error5',0,1770);
			makeLuaSprite('ArrowError2','error6',0,1770);
			
		elseif downscroll == true then
			makeLuaSprite('ArrowError','error7',0,-1770);
			makeLuaSprite('ArrowError2','error8',0,-1770);
		end
	...
	if difficulty == 2 then
		if downscroll == false then
			makeLuaSprite('ArrowError','error3',0,1770);
			makeLuaSprite('ArrowError2','error4',0,1770);
			
		elseif downscroll == true then
			makeLuaSprite('ArrowError','error',0,-1770);
			makeLuaSprite('ArrowError2','error2',0,-1770);
		end
